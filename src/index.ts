...
const card_f = document.getElementById("card_front") as HTMLDivElement;
const card_b = document.getElementById("card_back") as HTMLDivElement;

const iName = document.getElementById("i_name") as HTMLInputElement;
const iNumber = document.getElementById("i_number") as HTMLInputElement;
const iMonth = document.getElementById("i_month") as HTMLInputElement;
const iYear = document.getElementById("i_year") as HTMLInputElement;
const iCvc = document.getElementById("i_cvc") as HTMLInputElement;
...
function removeError(campusForm: HTMLInputElement): void {
  ...
  if (hasError) {
    ...
    if (parent.querySelector(".msg_e"))
      parent.querySelector(".msg_e")?.remove();
...
function createsErrorMessage(campusForm: HTMLInputElement) {
  const parent = campusForm.parentNode as HTMLElement;
